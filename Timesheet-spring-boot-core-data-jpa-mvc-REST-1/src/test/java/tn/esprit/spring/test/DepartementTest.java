...
public class DepartementTest {
	...
	public void affecterDepartementAEntrepriseTest ()
	{
		...
		this.depTest= new Departement();
		this.depTest.setName("departmenTest1");
		int entreId=entreService.ajouterEntreprise(this.entreprise);
		int depId=entreService.ajouterDepartement(this.depTest);

		entreService.affecterDepartementAEntreprise(depId, entreId);

		L.info("Departement with id={} added successfully to Entreprise with id={}", depId,entreId);
